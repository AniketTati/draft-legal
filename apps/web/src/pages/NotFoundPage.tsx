...
export function NotFoundPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center" data-testid="not-found">
      ...
      <h1 className="mt-3 text-lg font-semibold text-gray-900">This page doesn’t exist</h1>
      ...
      <p className="mt-1 text-sm text-gray-500">
        Nothing is routed at <code className="rounded bg-gray-100 px-1.5 py-0.5 text-[13px]">{pathname}</code>
      </p>
